...
def second_opinion(
    ...
    if gosterge:
        not_ = (
            "N/P/K girilmedi; veri seti medyanı kullanıldı. Sonuç yalnızca "
            "iklim-toprak benzerliği göstergesidir, toprak analizi ile güçlenir."
        )
    else:
        not_ = "Toprak analizi N/P/K değerleri kullanıldı."
